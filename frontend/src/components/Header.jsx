    ...
    <div className="bg-[#0F172A] h-full flex flex-col items-center gap-10 md:gap-20 pt-20 p-4 md:p-20">
      ...
      <div className="w-full">
        ...
        >
          ...
          />
          <button
            className="w-full md:w-[15%] px-4 py-2 bg-(--primary) rounded text-(--text) font-semibold hover:md:scale-105 hover:scale-102 transition-all duration-200"
      ...
      <div className="grid grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
        ...
        <button className="col-span-2 py-3 rounded-xl bg-(--primary) text-(--text) hover:scale-105 transition-all duration-200"
